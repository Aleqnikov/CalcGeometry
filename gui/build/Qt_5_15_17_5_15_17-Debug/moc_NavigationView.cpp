...
QT_MOC_LITERAL(1, 15, 12), // "returnToMenu"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 12), // "mouseMovedTo"
QT_MOC_LITERAL(4, 42, 8), // "scenePos"
QT_MOC_LITERAL(5, 51, 12) // "spacePressed"

    },
    "NavigationView\0returnToMenu\0\0mouseMovedTo\0"
    "scenePos\0spacePressed"
};
...
void NavigationView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mouseMovedTo((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        case 2: _t->spacePressed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NavigationView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NavigationView::returnToMenu)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (NavigationView::*)(QPointF );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NavigationView::mouseMovedTo)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (NavigationView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NavigationView::spacePressed)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject NavigationView::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsView::staticMetaObject>(),
    qt_meta_stringdata_NavigationView.data,
    qt_meta_data_NavigationView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void NavigationView::returnToMenu()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void NavigationView::mouseMovedTo(QPointF _t1)
{
...
// SIGNAL 2
void NavigationView::spacePressed()
{
